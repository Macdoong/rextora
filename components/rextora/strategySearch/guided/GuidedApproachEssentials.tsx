...
import { guidedControlClass, guidedNumberClass, guidedSelectClass } from "./guidedFieldClass";
    ...
    >
      ...
      <div className="ss-guided-approach-essentials__grid">
        <label className="ss-guided-field" htmlFor="ss-depth-guided">
          <span className="ss-field-label mb-1 block">탐색 수준</span>
          <select
            id="ss-depth-guided"
        ...
        <label className="ss-guided-field" htmlFor="ss-duration-guided">
          <span className="ss-field-label mb-1 block">탐색 시간</span>
          <select
        ...
        {props.durationPreset === "custom" ? (
          ...
          <p className="ss-guided-runtime-preset-note" data-testid="ss-runtime-preset-note">
            최대 실행 시간:{" "}
            {DURATION_PRESET_MINUTES[props.durationPreset as Exclude<DurationPresetId, "custom">] ??
