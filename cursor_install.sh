...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2026.07.09-a3815c0-$(date +%s)"
...
ln -s ~/.local/share/cursor-agent/versions/2026.07.09-a3815c0/cursor-agent ~/.local/bin/agent
ln -s ~/.local/share/cursor-agent/versions/2026.07.09-a3815c0/cursor-agent ~/.local/bin/cursor-agent
