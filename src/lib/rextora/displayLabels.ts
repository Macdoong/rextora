...
> = {
  ...
  market: {
    watchedSymbolCount: "동시에 감시할 코인 개수입니다. 단위: 개",
    allowedSymbols: "감시 대상으로 허용할 코인 목록입니다.",
    excludedSymbols: "감시에서 제외할 코인 목록입니다.",
    minQuoteVolume: "거래량이 너무 적은 코인을 제외하는 기준입니다. 단위: USDT",
    scanIntervalMs: "시장 데이터를 다시 스캔하는 간격입니다. 단위: ms",
    marketCacheTtlMs: "시장 데이터를 잠시 저장해 두는 시간입니다. 단위: ms",
    staleDataThresholdMs: "이 시간보다 오래되면 데이터를 지연으로 표시합니다. 단위: ms",
    maxKlineSymbolsPerScan: "한 번에 조회할 캔들 차트 코인 수입니다. 단위: 개",
    klineInterval: "캔들 차트 시간 간격입니다.",
    candidateRefreshIntervalMs: "AI 후보 목록을 다시 계산하는 간격입니다. 단위: ms",
  },
  signal: {
...
const BLOCK_REASON_MAP: Record<string, string> = {
  ...
  "전략 실전 승인이 필요합니다.": "전략 실전 승인이 필요합니다.",
  "승인된 전략과 현재 실전 대상이 다릅니다.": "승인된 전략과 현재 실전 대상이 다릅니다.",
  "승인된 전략 파라미터와 현재 실전 대상이 다릅니다.": "승인된 전략 파라미터와 현재 실전 대상이 다릅니다.",
  "승인된 전략 해시와 현재 실전 대상이 다릅니다.": "승인된 전략 해시와 현재 실전 대상이 다릅니다.",
  "승인된 백테스트와 현재 실전 대상이 다릅니다.": "승인된 백테스트와 현재 실전 대상이 다릅니다.",
  "실전 승인 대상 신원이 없어 시작할 수 없습니다.": "실전 승인 대상 신원이 없어 시작할 수 없습니다.",
};
