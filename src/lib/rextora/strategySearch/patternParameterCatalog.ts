...
const OB: readonly PatternParameterCatalogEntry[] = [
  ...COMMON,
  field("bodyOnly", "bool", { min: false, default: true, max: true, step: null, labelKo: "몸통 존", detectorField: "orderBlock.bodyOnly", mutationEligible: true, explanationLabel: "존 경계 기준" }),
