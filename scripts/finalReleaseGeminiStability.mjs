/**
 * OpenAI gemini-2.5-flash stability gate — 30+ multi-turn messages.
 */
...
const outDir = path.join(root, "tmp/provider-backed-final-release/gemini-stability");
...
const sessionId = `agent_gemini_stab_${Date.now().toString(36)}`;
